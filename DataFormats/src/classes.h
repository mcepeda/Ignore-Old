...
namespace {
  struct UWanalysis_DataFormats_dictionary {
   ...
   /// create dictionaries for PATMuNuJetJetQuad objects
   PATMuNuJetJetQuad dummyPATMuNuJetJetQuad;
   edm::Wrapper<PATMuNuJetJetQuad> dummyPATMuNuJetJetTauQuadWrapper;
   PATMuNuJetJetQuadCollection dummyPATMuNuJetJetQuadCollection;
   edm::Wrapper<PATMuNuJetJetQuadCollection> dummyPATMuNuJetJetQuadCollectionWrapper;
   edm::Ptr<PATMuNuJetJetQuad> dummyPATMuNuJetJetQuadPtr;

   /// create dictionaries for PATElectronNuJetJetQuad objects
   PATEleNuJetJetQuad dummyPATEleNuJetJetQuad;
   edm::Wrapper<PATEleNuJetJetQuad> dummyPATEleNuJetJetTauQuadWrapper;
   PATEleNuJetJetQuadCollection dummyPATEleNuJetJetQuadCollection;
   edm::Wrapper<PATEleNuJetJetQuadCollection> dummyPATEleNuJetJetQuadCollectionWrapper;
   edm::Ptr<PATEleNuJetJetQuad> dummyPATEleNuJetJetQuadPtr;

   /// create dictionaries for PATTauNuJetJetQuad objects
   PATTauNuJetJetQuad dummyPATTauNuJetJetQuad;
   edm::Wrapper<PATTauNuJetJetQuad> dummyPATTauNuJetJetTauQuadWrapper;
   PATTauNuJetJetQuadCollection dummyPATTauNuJetJetQuadCollection;
   edm::Wrapper<PATTauNuJetJetQuadCollection> dummyPATTauNuJetJetQuadCollectionWrapper;
   edm::Ptr<PATTauNuJetJetQuad> dummyPATTauNuJetJetQuadPtr;
