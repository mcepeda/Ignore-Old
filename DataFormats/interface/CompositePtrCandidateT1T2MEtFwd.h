...
typedef std::vector<PATJetPair> PATJetPairCollection;
typedef std::vector<PATMuMuJJQuad> PATMuMuJJQuadCollection;
typedef std::vector<PATTauNuJetJetQuad> PATTauNuJetJetQuadCollection;
typedef std::vector<PATMuNuJetJetQuad> PATMuNuJetJetQuadCollection;
typedef std::vector<PATEleNuJetJetQuad> PATEleNuJetJetQuadCollection;
