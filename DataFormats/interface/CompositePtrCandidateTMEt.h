...
class CompositePtrCandidateTMEt : public reco::LeafCandidate 
{
 ...
 public:
  ...
  math::XYZTLorentzVector WP4B()  const {return WP4B_;}
 ...
 private:
  ...
  void setMetPz(double metPz) {metPz_=metPz;}
  void setMetPzB(double metPzB) {metPzB_=metPzB;}
  void setIsComplex(double isPzSolutionComplex){isPzSolutionComplex_=isPzSolutionComplex;}
  void setWP4 ( math::XYZTLorentzVector WP4) {WP4_=WP4;} 
  void setWP4B ( math::XYZTLorentzVector WP4B) {WP4B_=WP4B;}
